...
CREATE TABLE "gamesToImport" (
    ...
    CONSTRAINT "gamesToImport_pkey" PRIMARY KEY ("id")
);
...
-- AddForeignKey
ALTER TABLE "gamesToImport" ADD CONSTRAINT "gamesToImport_user_id_fkey" FOREIGN KEY ("user_id") REFERENCES "users"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
